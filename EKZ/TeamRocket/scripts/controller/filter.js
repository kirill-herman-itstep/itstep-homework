...
function inputs() {
    if (document.querySelector('.filterLayout')) {
        ...
        filterLayoutInputs.forEach(e => e.addEventListener('input', () => {
            ...
            let isPrivate;
            if (document.querySelector('.filterLayout .access input:checked')) {
                isPrivate = document.querySelector('.filterLayout .access input:checked').value;
...
function clearInputs() {
    const filterLayoutInputs = document.querySelectorAll('.filterLayout input')
    filterLayoutInputs.forEach(e => e.value = '')
    filterView.filter()
    clickableTasks()
}