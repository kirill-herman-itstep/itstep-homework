...
export function mockTasksArray() {
    return [
    new Task('Make world better', 'medium', 'We can kill all people? Maybe not, but, we have superpower!!!', 'Mark', 'to do', false),
    ...
    new Task('Chill and relax', 'low', 'Chiiiiil', 'Mark'),
    new Task('Listen Lo-fi radio', 'low'),
    new Task('Found new epic tracks', 'high', 'Sawano Hiroyuki maybe?'),
    new Task('Sawano always be the best', 'medium', 'ALL THE TIME'),
